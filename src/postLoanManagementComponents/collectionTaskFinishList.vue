      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button @click="mailList(scope.row)" type="text" size="small">通讯录</el-button>
            <el-button @click="contacts(scope.row)" type="text" size="small">紧急联系人</el-button>
            <el-button @click="task(scope.row)" type="text" size="small">催记</el-button>
          </template>
        </el-table-column>
      </el-table>
    </template>

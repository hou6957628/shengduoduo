      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button @click="mailList(scope.row)" type="text" size="medium">通讯录</el-button>
            <el-button @click="Contacts(scope.row)" type="text" size="medium">紧急联系人</el-button>
          </template>
        </el-table-column>
      </el-table>
    </template>
  ...
  export default {
    methods: {
      ...
      getGroupList() {
        axios({
          method:"POST",
          url:"http://"+this.baseUrl+"/operate/admin/group/getGroupList",
          headers:{
            'Content-Type':'application/x-www-form-urlencoded',
            'Authorization': localStorage.token
          }

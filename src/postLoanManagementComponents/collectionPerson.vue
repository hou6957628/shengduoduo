    ...
    methods: {
      ...
      getProductList(){
        axios({
          ...
          if(res.data.msgCd=='ZYCASH-200'){
            this.ruleForm.operationRoleList=res.data.body.operationRoleList;
            this.ruleForm.operationGroupList=res.data.body.operationGroupList;
            this.ruleForm.operationMerchantProductList1=res.data.body.operationMerchantProductList;
            for(var i=0;i<this.ruleForm.operationMerchantProductList1.length;i++){
              this.ruleForm.operationMerchantProductList.push({
                productId:this.ruleForm.operationMerchantProductList1[i].productId,
                productName:this.ruleForm.operationMerchantProductList1[i].productName
              });
              this.$forceUpdate();

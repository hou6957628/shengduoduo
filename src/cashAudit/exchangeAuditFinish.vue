      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.status==2" @click="sendProduct(scope.row)" type="text" size="medium">确认收货</el-button>
            <el-button v-if="scope.row.status==0" @click="sendProduct1(scope.row)" type="text" size="medium">发货</el-button>
            <el-button v-if="scope.row.status==3" @click="repeatSendProduct(scope.row)" type="text" size="medium">重新发货</el-button>
            <el-button v-if="scope.row.status==1||scope.row.status==0" @click="prohibitBtn(scope.row)" type="text" size="medium">取消</el-button>
          </template>
        </el-table-column>
      </el-table>
    </template>

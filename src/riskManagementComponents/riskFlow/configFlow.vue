<template>
  <div class="content">
    <el-breadcrumb class="fs-16" separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/ruleSetConfiguration' }">风控流程管理</el-breadcrumb-item>
      <el-breadcrumb-item>配置风控流程</el-breadcrumb-item>
    </el-breadcrumb>
    <h3 class="mt_20">风控流程</h3>
    <el-row :gutter="20">
    ...
    <el-row :gutter="20">
      ...
      <el-col>对应使用的风控流程: <div class="grid-content">应用1、应用2、应用3、应用4</div><p style="float: right;color:red;margin-right: 50px">修改记录</p></el-col>
    </el-row>

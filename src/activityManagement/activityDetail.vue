    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="起止时间" prop="position">
        <el-date-picker
          ...
          unlink-panels
          range-separator="至"
          :start-placeholder="ruleForm.position1"
          :end-placeholder="ruleForm.position2"
  ...
  export default {
    ...
    methods: {
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            axios({
              method:"POST",
              url:"http://"+this.baseUrl+"/flowPool/admin/activity_planing/edit",
              headers:{
      ...
      getProductList(){
        axios({
          method:"GET",
          url:"http://"+this.baseUrl+"/flowPool/admin/activity_planing/searchById",
          headers:{
            'Content-Type':'application/x-www-form-urlencoded',
          ...
          if(res.data.msgCd=='ZYCASH-200'){
            ...
            this.ruleForm.position1=res.data.body.startDate;
            this.ruleForm.position2=res.data.body.endDate;
            this.startDate=res.data.body.startDate;
            this.endDate=res.data.body.endDate;

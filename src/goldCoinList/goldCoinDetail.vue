<template>
  <div class="content">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="140px" class="demo-ruleForm">
      ...
      <el-form-item label="活动规则说明" prop="fileDescription">
        <el-input type="textarea" v-model="ruleForm.fileDescription" placeholder="活动规则说明"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(this.ruleForm.iconFile){
              param.append('iconFile', this.ruleForm.iconFile);
            }
            if(this.ruleForm.showFile){
            ...
            if(this.ruleForm.introduceFile){
            ...
            param.append('fileDescription', this.ruleForm.fileDescription);
            axios({
              method:"POST",
      ...
      getProductList(data1){
        axios({
          method:"POST",
          url:"http://"+this.baseUrl+"/flowPool/admin/prizes/getPrizesInfo",
          headers:{
            'Content-Type':'application/x-www-form-urlencoded',
          ...
          if(res.data.msgCd=='ZYCASH-200'){
            ...
            if(res.data.body.files==""){
              this.ruleForm.files=[{type:'',imageUrlFile:'',description:''},{type:'',imageUrlFile:'',description:''}];
            }
            this.specify=res.data.body.specifyCustomerId;
            this.ruleForm.image="如需修改请点击上传";
            this.ruleForm.showImage="如需修改请点击上传";
            this.ruleForm.introduceImage="如需修改请点击上传";
          }else {
            this.$message.error(res.data.msgInfo);
          }
        })

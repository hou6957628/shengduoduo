<template>
  <div class="content">
    ...
    <el-button-group style="margin: 0 auto;width: 900px;display: block;margin-top: 40px;margin-bottom: 40px">
      ...
      <el-button class="la" type="danger" @click="lineDefferTip()">展期</el-button>
      <el-button class="la" type="danger" @click="cancelAuditOrder()">部分还款</el-button>
    ...
    <div class="listContent">
      ...
      <router-link :to="'/fenxianOrder2/' + this.id" tag="li">风险命中列表</router-link>

<template>
  <div class="content">
    ...
    <div class="bankBox">
      ...
      <p><span>ICON图：</span><img style="height: 108px;width: 170px" :src="'http://39.105.217.251:31999/message/admin/message/down?file='+ruleForm.picture+'&productCode='+ruleForm.productCode"/></p>
    </div>

<template>
  <div class="content">
    <el-breadcrumb class="fs-16" separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>创建推送消息</el-breadcrumb-item>
    </el-breadcrumb>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm">
      ...
      <el-form-item label="LOGO" prop="filename">
        ...
        <el-alert :closable="false" style="padding: 3px 16px;" title="LOGO推荐尺寸（80*80）" type="success"></el-alert>
      </el-form-item>
      <el-form-item>

  ...
  <div class="content">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm">
      ...
      <el-form-item label="ICON图标" prop="filename">
        ...
        <el-alert :closable="false" style="padding: 3px 16px;" title="icon图片类型:png,jpg  推荐尺寸（80*80）" type="success"></el-alert>
      </el-form-item>
      <el-form-item style="margin-top: 20px" label="选择位置:" prop="roleName">
        <el-select v-model="ruleForm.roleName" value-key="id" placeholder="请选择" @change="selectChange2($event,electData1)">
          <el-option
      ...
      <el-form-item label="发送次数:" prop="mobile">
        <el-input v-model="ruleForm.mobile"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  export default {
    data() {
      ...
      return {
        ...
        electData: [
          {roleId:0,roleName:"页1"},
          {roleId:1,roleName:"页2"},
        ],
        electData1: [],
        electData2: [],
        tableData:[],
